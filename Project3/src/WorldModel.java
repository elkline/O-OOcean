   ...
   public boolean processLine(String line, WorldModel world, ImageStore imageStore)
   {
      ...
      if (properties.length > 0)
      {
         switch (properties[PROPERTY_KEY])
         {
            ...
            case OCTO_KEY:
               return Parse.parseOcto(properties, world, imageStore);
            case OBSTACLE_KEY:
               return Parse.parseObstacle(properties, world, imageStore);
            case FISH_KEY:
               return Parse.parseFish(properties, world, imageStore);
            case ATLANTIS_KEY:
               return Parse.parseAtlantis(properties, world, imageStore);
            case SGRASS_KEY:
               return Parse.parseSgrass(properties, world, imageStore);
         }
      }
