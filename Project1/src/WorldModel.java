...
final class WorldModel
{
   ...
   {
      for (int dy = -(Entity.getFishReach()); dy <= Entity.getFishReach(); dy++)
      {
         for (int dx = -(Entity.getFishReach()); dx <= Entity.getFishReach(); dx++)
         {
   ...
   public void load(Scanner in, ImageStore imageStore)
   {
      ...
      while (in.hasNextLine())
      {
         try
         {
            if (!Entity.processLine(in.nextLine(), this, imageStore))
            {
